...
export function swiperInit() {
	...
	var introduce_5 = new Swiper(".introduce-5-slide .swiper", {
		modules: [Navigation],
		navigation: {
			prevEl: ".introduce-5-slide .swiper-button-prev",
			nextEl: ".introduce-5-slide .swiper-button-next",
		},
		observer: true,
		observeParents: true,
		breakpoints: {
	...
	var introduce_8 = new Swiper(".introduce-8 .swiper", {
		...
		navigation: {
			prevEl: ".introduce-8 .swiper-button-prev",
			nextEl: ".introduce-8 .swiper-button-next",
		},
	});
	...
	var cutru_2_3 = new Swiper(".cutru-2-3-slide .swiper", {
		...
		...swiperParameter,
		navigation: {
			prevEl: ".cutru-2-3-slide .swiper-button-prev",
			nextEl: ".cutru-2-3-slide .swiper-button-next",
		},
	});
